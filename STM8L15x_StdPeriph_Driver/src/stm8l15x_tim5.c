...
static void _TI1_Config(TIM5_ICPolarity_TypeDef TIM5_ICPolarity,
                       TIM5_ICSelection_TypeDef TIM5_ICSelection,
                       uint8_t TIM5_ICFilter);
static void _TI2_Config(TIM5_ICPolarity_TypeDef TIM5_ICPolarity,
                       TIM5_ICSelection_TypeDef TIM5_ICSelection,
                       uint8_t TIM5_ICFilter);
                 ...
                 uint8_t TIM5_ICFilter)
{
  ...
  {
    /* TI1 Configuration */
    _TI1_Config(TIM5_ICPolarity, TIM5_ICSelection, TIM5_ICFilter);
  ...
  {
    /* TI2 Configuration */
    _TI2_Config(TIM5_ICPolarity, TIM5_ICSelection, TIM5_ICFilter);
                     ...
                     uint8_t TIM5_ICFilter)
{
  ...
  {
    /* TI1 Configuration */
    _TI1_Config(TIM5_ICPolarity, TIM5_ICSelection,
               TIM5_ICFilter);
    ...
    /* TI2 Configuration */
    _TI2_Config((TIM5_ICPolarity_TypeDef)icpolarity, (TIM5_ICSelection_TypeDef)icselection, TIM5_ICFilter);
  ...
  {
    /* TI2 Configuration */
    _TI2_Config(TIM5_ICPolarity, TIM5_ICSelection,
               TIM5_ICFilter);
    ...
    /* TI1 Configuration */
    _TI1_Config((TIM5_ICPolarity_TypeDef)icpolarity, (TIM5_ICSelection_TypeDef)icselection, TIM5_ICFilter);
                                 ...
                                 uint8_t ICFilter)
{
  ...
  {
    _TI2_Config(TIM5_ICPolarity, TIM5_ICSelection_DirectTI, ICFilter);
  }
  else
  {
    _TI1_Config(TIM5_ICPolarity, TIM5_ICSelection_DirectTI, ICFilter);
  }
